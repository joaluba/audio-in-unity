...
public class audioplugin_BasicReverbGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_BasicReverb"; } }
    public override string Description    { get { return "BasicReverb"; } }
    public override string Vendor         { get { return "Paradigm E"; } }

    //==============================================================================
	[DllImport("audioplugin_BasicReverb")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_BasicReverb")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_BasicReverb")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_BasicReverb")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_BasicReverb")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_BasicReverb")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_BasicReverb")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
